...
description: >
  <2-3 句说明 Skill 做什么、适用什么汽车场景、核心价值>
...
```yaml
knowledge_areas:
  - area: "<核心知识域>"          # 本 Skill 必须精通的领域
    topics:
      - "<关键知识点 1>"
      - "<关键知识点 2>"
      - "<关键知识点 3>"

  - area: "<支撑知识域>"          # 按需引用的辅助领域
    topics:
      - "<支撑知识点 A>"
      - "<支撑知识点 B>"
```
...
instructions 是 LLM 执行时的核心指令，必须包含以下 5 段，缺一不可：

**段落 A：Core Competencies（能力声明）**
```
你是一名 [技术领域] 专家，精通：
- [核心能力 1]
- [核心能力 2]
...
**段落 C：Standards & Best Practices（规范遵循）**
```
- 遵循 rules/misra-c.md
...
**段落 E：Safety & Security Considerations（安全合规检查）**
```
- [安全检查项 1]
- [合规检查项 2]
- ✋ HUMAN CHECK：[触发条件]
...
- [ ] `instructions` 包含 A/B/C/D/E 全部 5 段
